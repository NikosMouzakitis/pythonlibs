    ...
    for t in range(0, 16):
        ...
        if (multicombo4[t] == 2):
            for j in range(0, 6):
                ...
                if ((k[t] and k[driver_4[t][j][0] + t] and k[driver_4[t][j][1] + t] and k[driver_4[t][j][2] + t] and (already_combined[t] != 0) and (already_combined[driver_4[t][j][0] + t] != 0) and (already_combined[driver_4[t][j][1] + t] != 0) and (already_combined[driver_4[t][j][2] + t] != 0)  )):
